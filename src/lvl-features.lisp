            ...
            (let ((dir (1+ (random 9)))
              ...
              (cond
                ((= dir-z -1) (when (and (not (zerop (z feature)))
                                         (not (get-terrain-type-trait (get-terrain-* level (x feature) (y feature) (z feature)) +terrain-trait-opaque-floor+))
                ...
                ((= dir-z 1) (when (and (< (z feature) (1- (array-dimension (terrain level) 2)))
                                        (not (get-terrain-type-trait (get-terrain-* level (x feature) (y feature) (1+ (z feature))) +terrain-trait-opaque-floor+))
