...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (let ((soldier (make-instance 'mob :mob-type +mob-type-thief+ :x (+ (x *player*) 5) :y (+ (y *player*) 0) :z 0))
    ...
    (add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-smoke+  :x (+ (x *player*) -1) :y (+ (y *player*) 0) :z (+ (z *player*) 0)))
