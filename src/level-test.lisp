...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (let ((soldier (make-instance 'mob :mob-type +mob-type-archangel+ :x (+ (x *player*) 0) :y (- (y *player*) 5)))
        (demon (make-instance 'mob :mob-type +mob-type-demon+ :x (+ (x *player*) 3) :y (+ (y *player*) 3))))
    ;(setf (cur-hp demon) 1)
