...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (setf *player* (make-instance 'player :mob-type +mob-type-imp+ :x 45 :y 19 :z 3))
  (add-mob-to-level-list (level world) *player*)
  
  (let (;(soldier (make-instance 'mob :mob-type +mob-type-archangel+ :x 41 :y 19 :z 2))
        ;(demon (make-instance 'mob :mob-type +mob-type-man+ :x 41 :y 18 :z 2))
   ...
   ; (setf (cur-fp demon) 2)
    ...
    (add-item-to-level-list (level world) (make-instance 'item :item-type +item-type-scroll-demonic-rune-flesh+ :x (+ (x *player*) 0) :y (+ (y *player*) 0) :z (+ (z *player*) 0) :qty 1))
    ...
    ;(add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-smoke-thin+  :x (+ (x *player*) -1) :y (+ (y *player*) 0) :z (+ (z *player*) 0)))
    ;(add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-smoke-thin+  :x (+ (x *player*) -1) :y (+ (y *player*) 0) :z (+ (z *player*) 0)))
    (add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-demonic-portal+  :x (+ (x *player*) 3) :y (+ (y *player*) 2) :z (+ (z *player*) 0)))
    (add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-demonic-rune-flesh+ :x 40 :y 19 :z 1))
