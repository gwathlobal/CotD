...
(defun test-level-place-mobs (world)
  ...
  (setf *player* (make-instance 'player :mob-type +mob-type-soldier+ :x 47 :y 18 :z 1))
  ...
  (let (;(soldier (make-instance 'mob :mob-type +mob-type-satanist+ :x 49 :y 20 :z 1))
   ...
   ; (setf (cur-fp demon) 2)
    ...
    (add-item-to-level-list (level world) (make-instance 'item :item-type +item-type-bomb+ :x (+ (x *player*) 0) :y (+ (y *player*) 0) :z (+ (z *player*) 0) :qty 1))
    (add-item-to-level-list (level world) (make-instance 'item :item-type +item-type-bomb+ :x (+ (x *player*) 0) :y (+ (y *player*) 0) :z (+ (z *player*) 0) :qty 1))
    ...
    (add-feature-to-level-list (level world) (make-instance 'feature :feature-type +feature-bomb-plant-target+ :x 41 :y 19 :z 1))
