...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (setf *player* (make-instance 'player :mob-type +mob-type-archdemon+ :x 45 :y 19 :z 3))
  (add-mob-to-level-list (level world) *player*)
  
  (let ((soldier (make-instance 'mob :mob-type +mob-type-thief+ :x 41 :y 19 :z 3))
    ...
    (setf (cur-hp *player*) 5)
    (setf (cur-fp soldier) 2)
    (setf (cur-hp soldier) 3)
   ; (setf (cur-fp demon) 2)
