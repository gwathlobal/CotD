...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (let ((soldier (make-instance 'mob :mob-type +mob-type-thief+ :x 41 :y 19 :z 2))
        ;demon (make-instance 'mob :mob-type +mob-type-thief+ :x 42 :y 19 :z 3))
        (angel (make-instance 'mob :mob-type +mob-type-demon+ :x 43 :y 17 :z 3))
        )
