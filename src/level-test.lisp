...
(defun test-level-place-mobs (world mob-template-list)
  ...
  (setf *player* (make-instance 'player :mob-type +mob-type-angel+ :x 46 :y 15 :z 0))
  (add-mob-to-level-list (level world) *player*)
  (let ((soldier (make-instance 'mob :mob-type +mob-type-demon+ :x (+ (x *player*) 7) :y (+ (y *player*) 0) :z 0))
