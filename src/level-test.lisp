...
(defun test-level-place-mobs (level)
  ...
  (let (;(priest (make-instance 'mob :mob-type +mob-type-priest+ :x (+ (x *player*) 5) :y (- (y *player*) 0)))
        (demon (make-instance 'mob :mob-type +mob-type-satanist+ :x (+ (x *player*) 3) :y (+ (y *player*) 0))))
    ;(setf (cur-hp demon) 1)
