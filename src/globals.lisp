...
(defconstant +mob-abil-create-parasites+ 91)
(defconstant +mob-abil-adrenal-gland+ 92)
(defconstant +mob-abil-mutate-acid-spit+ 93)
(defconstant +mob-abil-acid-spit+ 94)
(defconstant +mob-abil-mutate-corrosive-bile+ 95)
(defconstant +mob-abil-corrosive-bile+ 96)
(defconstant +mob-abil-mutate-clawed-tentacle+ 97)
(defconstant +mob-abil-clawed-tentacle+ 98)
(defconstant +mob-abil-mutate-chitinous-plating+ 99)
(defconstant +mob-abil-chitinous-plating+ 100)
(defconstant +mob-abil-mutate-metabolic-boost+ 101)
