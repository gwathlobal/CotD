...
(defmethod initialize-instance :after ((mob-type mob-type) &key armor
                                                                ...
                                                                abil-mutate-poisoning-glands abil-purge-rune abil-civilian abil-deep-breath abil-nameless abil-strength-in-numbers abil-coward)
  ;; set up armor
  ...
  (when abil-skinchange-to-melee
    (setf (gethash +mob-abil-skinchange-to-melee+ (abilities mob-type)) t))
  (when abil-skinchange-to-ranged
    (setf (gethash +mob-abil-skinchange-to-ranged+ (abilities mob-type)) t))
  (when abil-skinchange-to-flyer
    (setf (gethash +mob-abil-skinchange-to-flyer+ (abilities mob-type)) t))
  (when abil-mutate-skin-ranged-to-turret
    (setf (gethash +mob-abil-mutate-skin-ranged-to-turret+ (abilities mob-type)) t))
  (when abil-mutate-charge
    (setf (gethash +mob-abil-mutate-charge+ (abilities mob-type)) t))
  (when abil-mutate-explosive-glands
    (setf (gethash +mob-abil-mutate-explosive-glands+ (abilities mob-type)) t))
  (when abil-mutate-poisoning-glands
    (setf (gethash +mob-abil-mutate-poisoning-glands+ (abilities mob-type)) t))
  ...
  (when abil-strength-in-numbers
    (setf (gethash +mob-abil-strength-in-numbers+ (abilities mob-type)) t))
  (when abil-coward
    (setf (gethash +mob-abil-coward+ (abilities mob-type)) t)))
...
(defclass mob ()
  ((id :initform 0 :initarg :id :accessor id :type fixnum)
   ...
   (stat-corpses-thrown :initform 0 :accessor stat-corpses-thrown)
