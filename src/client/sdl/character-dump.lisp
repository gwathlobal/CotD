...
(defun return-scenario-stats (&optional (on-screen t))
  (let ((str (create-string)))
    ...
    (format str "          Humans: total ~A, killed ~A, left ~A~A~%" (initial-humans (level *world*)) (- (initial-humans (level *world*)) (total-humans (level *world*))) (total-humans (level *world*)) (new-line on-screen))
    (format str "          Angels: total ~A, killed ~A, left ~A~A~%" (initial-angels (level *world*)) (- (initial-angels (level *world*)) (total-angels (level *world*))) (total-angels (level *world*)) (new-line on-screen))
    (format str "          Demons: total ~A, killed ~A, left ~A~A~%" (initial-demons (level *world*)) (- (initial-demons (level *world*)) (total-demons (level *world*))) (total-demons (level *world*)) (new-line on-screen))
    (format str "          Undead: total ~A, killed ~A, left ~A~A~%" (initial-undead (level *world*)) (- (initial-undead (level *world*)) (total-undead (level *world*))) (total-undead (level *world*)) (new-line on-screen))
    (format str "~%")
