...
(set-terrain-type (make-instance 'terrain-type :id +terrain-door-closed+ :glyph-idx 11 :glyph-color (sdl:color :r 139 :g 69 :b 19) :back-color sdl:*black* :name "Closed door"
                                               :trait-blocks-move t :trait-blocks-projectiles t :trait-blocks-vision t :trait-opaque-floor t :trait-blocks-sound 15 :trait-blocks-sound-floor 20))
(set-terrain-type (make-instance 'terrain-type :id +terrain-border-air+ :glyph-idx 96 :glyph-color sdl:*cyan* :back-color sdl:*black* :name "Air"
