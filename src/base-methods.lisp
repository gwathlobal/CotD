...
(defun print-visible-message (x y z level str &key (observed-mob nil) (color sdl:*white*))
  ...
  (let ((dead-msg-str (format nil "~A dies. " (capitalize-name (prepend-article +article-the+ (visible-name mob)))))
    ...
    (when msg
      (if (eq (id mob) (riding-mob-id *player*))
        ...
        (print-visible-message (x mob) (y mob) (z mob) (level *world*) dead-msg-str :color (sdl:color :r 150 :g 0 :b 0)))
...
(defun adjust-disguise-for-mob (mob)
  ...
  (when (mob-effect-p mob +mob-effect-divine-concealed+)
    (if (angel-disguised-mob-type-id (get-mission-scenario-by-id (mission-scenario (level *world*))))
      (setf (face-mob-type-id mob) (angel-disguised-mob-type-id (get-mission-scenario-by-id (mission-scenario (level *world*)))))
