...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-player+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-dead-player+
                                             :type +scenario-feature-player-faction+ :debug t
                                             :name "Dead player"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-angel-chrome+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-demon-crimson+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-military-chaplain+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-military-scout+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-thief+
                                             :type +scenario-feature-player-faction+
                                             :name "Thief"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-satanist+
                                             :type +scenario-feature-player-faction+
                                             :name "Satanists"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-priest+
                                             :type +scenario-feature-player-faction+
                                             :name "Church"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-demon-shadow+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-angel-trinity+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-eater+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-attack-ghost+
                                             :type +scenario-feature-player-faction+
                                             :name "Lost soul"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
