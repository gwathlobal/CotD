...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-player+
                                             ...
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-player+ faction-list mob-func-list))

                                                       (setf game-event-list (scenario-delayed-faction-setup-military-raid faction-list game-event-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-dead-player+
                                             :type +scenario-feature-player-faction+ :debug t
                                             :name "Dead player"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-dead-player+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-angel-chrome+
                                             :type +scenario-feature-player-faction+
                                             :name "Celestial Communion (as Chrome angel)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-angel-chrome+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-angel-trinity+
                                             :type +scenario-feature-player-faction+
                                             :name "Celestial Communion (as Trinity mimics)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-angel-trinity+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-demon-crimson+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Crimson imp)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-demon-crimson+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-demon-shadow+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Shadow imp)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-demon-shadow+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-demon-malseraph+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Malseraph's puppet)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-demon-malseraph+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-military-chaplain+
                                             :type +scenario-feature-player-faction+
                                             :name "Military (as Chaplain)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-military-chaplain+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-military-scout+
                                             :type +scenario-feature-player-faction+
                                             :name "Military (as Scout)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-military-scout+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-eater+
                                             :type +scenario-feature-player-faction+
                                             ...
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-eater+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-raid-ruined-skinchanger+
                                             :type +scenario-feature-player-faction+
                                             :name "Skinchanger"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-military-raid-ruined +specific-faction-type-skinchanger+ faction-list mob-func-list))
