...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-steal-skinchanger+
                                             :type +scenario-feature-player-faction+
                                             :name "Skinchanger"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-steal +specific-faction-type-skinchanger+ faction-list mob-func-list))
