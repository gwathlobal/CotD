...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-player+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-dead-player+
                                             :type +scenario-feature-player-faction+ :debug t
                                             :name "Dead player"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-angel-chrome+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-angel-trinity+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-demon-crimson+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-demon-shadow+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-demon-malseraph+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-military-chaplain+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-military-scout+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-corrupted-eater+
                                             :type +scenario-feature-player-faction+
