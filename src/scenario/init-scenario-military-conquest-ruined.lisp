...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-player+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-dead-player+
                                             :type +scenario-feature-player-faction+ :debug t
                                             :name "Dead player"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-angel-chrome+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-angel-trinity+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-demon-crimson+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-demon-shadow+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-demon-malseraph+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-military-chaplain+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-military-scout+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-eater+
                                             :type +scenario-feature-player-faction+
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-military-conquest-ruined-skinchanger+
                                             :type +scenario-feature-player-faction+
                                             :name "Skinchanger"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
