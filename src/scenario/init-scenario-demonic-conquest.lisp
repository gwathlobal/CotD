...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-player+
                                             ...
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-player+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-dead-player+
                                             :type +scenario-feature-player-faction+ :debug t
                                             :name "Dead player"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-dead-player+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-angel-chrome+
                                             :type +scenario-feature-player-faction+
                                             :name "Celestial Communion (as Chrome angel)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-angel-chrome+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-angel-trinity+
                                             :type +scenario-feature-player-faction+
                                             :name "Celestial Communion (as Trinity mimics)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-angel-trinity+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-demon-crimson+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Crimson imp)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-demon-crimson+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-demon-shadow+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Shadow imp)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-demon-shadow+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-demon-malseraph+
                                             :type +scenario-feature-player-faction+
                                             :name "Pandemonium Hierarchy (as Malseraph's puppet)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-demon-malseraph+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-military-chaplain+
                                             :type +scenario-feature-player-faction+
                                             :name "Military (as Chaplain)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-military-chaplain+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-military-scout+
                                             :type +scenario-feature-player-faction+
                                             :name "Military (as Scout)"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-military-scout+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-thief+
                                             :type +scenario-feature-player-faction+
                                             :name "Thief"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-thief+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-satanist+
                                             :type +scenario-feature-player-faction+
                                             :name "Satanists"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-satanist+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-priest+
                                             :type +scenario-feature-player-faction+
                                             :name "Church"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ;; it is important that the player setup function is the last to be pushed so that it is the first to be processed, otherwise everything will break

                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-priest+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-eater+
                                             :type +scenario-feature-player-faction+
                                             ...
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-eater+ faction-list mob-func-list))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-skinchanger+
                                             :type +scenario-feature-player-faction+
                                             :name "Skinchanger"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
...
(set-scenario-feature (make-scenario-feature :id +sf-faction-demonic-conquest-ghost+
                                             :type +scenario-feature-player-faction+
                                             :name "Lost soul"
                                             :func #'(lambda (layout-func template-processing-func-list post-processing-func-list mob-func-list game-event-list faction-list mission-id)
                                                       (declare (ignore mission-id))
                                                       ...
                                                       (setf mob-func-list (scenario-present-faction-setup-demonic-conquest +specific-faction-type-ghost+ faction-list mob-func-list))
