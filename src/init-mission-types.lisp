...
(set-mission-type :id :mission-type-demonic-attack
                  ...
                  :campaign-result (list (list :game-over-angels-won nil)
                                         (list :game-over-demons-won (list #'transform-residential-sector-to-abandoned #'move-military-to-free-sector #'neutrals-capture-book-of-rituals))
                                         (list :game-over-military-won nil)
                                         (list :game-over-church-won nil)
                                         (list :game-over-satanists-won (list #'transform-residential-sector-to-abandoned #'move-military-to-free-sector #'neutrals-capture-book-of-rituals))
                                         (list :game-over-eater-won (list #'transform-residential-sector-to-abandoned #'move-military-to-free-sector #'neutrals-capture-book-of-rituals)))
                  )
...
(set-mission-type :id :mission-type-military-conquest
                  ...
                  :campaign-result (list (list :game-over-angels-won (list #'transform-corrupted-sector-to-residential #'move-relic-to-church #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
                                         (list :game-over-demons-won nil)
                                         (list :game-over-military-won (list #'transform-corrupted-sector-to-residential #'move-relic-to-church #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
                                         (list :game-over-church-won (list #'transform-corrupted-sector-to-residential #'move-relic-to-church #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
...
(set-mission-type :id :mission-type-military-raid
                  ...
                  :campaign-result (list (list :game-over-angels-won (list #'transform-abandoned-sector-to-residential #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
                                         (list :game-over-demons-won nil)
                                         (list :game-over-military-won (list #'transform-abandoned-sector-to-residential #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
                                         (list :game-over-church-won (list #'transform-abandoned-sector-to-residential #'move-demons-to-free-sector #'humans-capture-book-of-rituals))
                                         (list :game-over-satanists-won nil)
...
(set-mission-type :id :mission-type-celestial-purge
                  ...
                  :campaign-result (list (list :game-over-angels-won (list #'transform-corrupted-sector-to-abandoned #'move-demons-to-free-sector #'neutrals-capture-book-of-rituals))
                                         (list :game-over-demons-won nil)
                                         (list :game-over-military-won (list #'transform-corrupted-sector-to-abandoned #'move-demons-to-free-sector #'neutrals-capture-book-of-rituals))
                                         (list :game-over-church-won (list #'transform-corrupted-sector-to-abandoned #'move-demons-to-free-sector #'neutrals-capture-book-of-rituals))
                                         (list :game-over-satanists-won nil)
                                         (list :game-over-eater-won (list #'move-demons-to-free-sector)))
                  )
