...
(set-feature-type (make-instance 'feature-type :id +feature-smoke+ :glyph-idx 98 :glyph-color (sdl:color :r 200 :g 200 :b 200) :back-color sdl:*black* :name "Smoke" :trait-blocks-vision 80))
